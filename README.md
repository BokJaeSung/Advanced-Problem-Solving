...
| Folder | Topic |
|--------|-------|
| `Lec.01_Introduction` | Introduction |
| `Lec.02_Numerical_Problems` | Numerical Problems |
| `Lec.03_Geometric_Problems` | Geometric Problems |
| `Lec.04_String_Matching` | String Matching |
| `Lec.05_Graph_Problems_1` | Graph Problems (1) |
| `Lec.06_Graph_Problems_2` | Graph Problems (2) |
