...
|-----|-------|----------|----------------|
| [`Lec.04`](Lec.04_String_Matching/) | String Matching | [Pattern Matching](Lec.04_String_Matching/1_string_pattern_matching.py) · [String Exponentiation](Lec.04_String_Matching/2_string_exponentiation.py) · [Longest Repeated Substring](Lec.04_String_Matching/3_longest_repeated_substring.py) | KMP, Rabin-Karp, Suffix Array |
...
| Lec | Topic | Problems | Key Algorithms |
|-----|-------|----------|----------------|
| [`Lec.05`](Lec.05_Graph_Problems_1/) | Graph Problems (1) | [LCA](Lec.05_Graph_Problems_1/1_lowest_common_ancestor.py) · [Distance on Tree](Lec.05_Graph_Problems_1/2_distance_on_tree.py) · [RMQ](Lec.05_Graph_Problems_1/3_range_minimum_query.py) | Binary Lifting, Sparse Table |
